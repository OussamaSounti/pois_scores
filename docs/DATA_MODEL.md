...
The POI schema is **not** defined by application migrations. It comes from the POI pipeline’s PostgreSQL dump. This file should be filled **after** the first restore so the backend and docs stay aligned with the real database.
