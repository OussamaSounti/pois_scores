...
export const SCORE_TOOLTIPS: Record<string, string> = {
  ...
  n_categories: "Number of distinct super-categories (e.g. Transport, Healthcare) present within 1 km.",
  n_poi_types: "Number of distinct POI types (fclass) within 1 km.",
  entropy: "Shannon entropy of the category distribution within 1 km. Higher = more balanced mix of categories.",
  entropy_fclass: "Shannon entropy of the POI-type (fclass) distribution within 1 km. Higher = more variety of types.",
  by_category: "Count of POIs per super-category within 1 km.",
  accessibility_400m: "Whether key POI types (e.g. bus stop, pharmacy) are present within 400 m walk.",
