...
by ``scripts/load_osm_*.py``.

Domain constants (radii, accessibility types, score-feature column names,
POI source enums) live in ``app.constants`` and are not configurable.
"""
...
class Settings(BaseSettings):
    ...
    # Overpass / OSM ingest. Used by scripts/load_osm_land.py and
    # scripts/load_osm_coastline.py.
