"""Pydantic schemas for the score API request/response."""

from datetime import date

from pydantic import BaseModel, ConfigDict, Field

from app.core.constants import BATCH_MAX_LOCATIONS
...
class ScoresPayload(BaseModel):
    ...
    entropy: float = Field(
        ..., description="Shannon entropy of category distribution in 1 km (bits)"
    )
